...
<?php
 ...
 $hasilQuery = $DB->prepare("select KodeProduk, NamaProduk, HargaModal from produk");
 $hasilQuery->execute();
 ...
 array_push($json_data, $json_array);  //Fungsi array_push() berfungsi untuk menyisipkan satu atau lebih elemen ke akhir array.
 }
 
 $data_produk = json_encode($json_data);  //Fungsi json_encode berfungsi untuk merubah data array menjadi data json
?>
<script type="text/javascript">
 var dataProduk = <?php echo $data_produk; ?>;
 var indeks = 0;
...
<table  id="tabel" style="visibility:hidden" border="1" width="100%">
 <thead>
	 ...
	 <tr>
		 <td><form><input type="checkbox" id="hapus[]" name="hapus"></form></td>
		 <td><?=$no?></td>
	 ...
	 <tr><td colspan="5"><button onclick="hapus();">Hapus Data</button></tr>
</table>
</body>
</html>
